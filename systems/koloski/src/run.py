...
if __name__ == "__main__":
    ...
    bar.add_argument('--fullbatch', action='store_const', dest="model", const="fullbatch",
                     help='Monolingual Fullbatch model')
    bar.add_argument('--extended', action='store_const', dest="model", const="extended",
                     help='Monolingual extended grid model')
