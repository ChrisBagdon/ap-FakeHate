...
es_data = pd.read_csv('../data/es_data.tsv', delimiter='\t', encoding='utf-8')
...
es_data.to_csv('../data/clean_es_data_v1.tsv', sep='\t', index=False)
...
es_data.to_csv('../data/clean_es_data_v2.tsv', sep='\t', index=False)
