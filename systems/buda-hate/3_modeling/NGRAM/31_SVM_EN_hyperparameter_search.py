...
filename = '../../training_results/EN/svm_tfidf_1_cs.pickle'
...
v1_df.to_csv('../../training_results/EN/svm_tfidf_results_v1.tsv', sep='\t', index=False)
...
filename = '../../training_results/EN/svm_tfidf_2_cs.pickle'
...
v2_df.to_csv('../../training_results/EN/svm_tfidf_results_v2.tsv', sep='\t', index=False)
