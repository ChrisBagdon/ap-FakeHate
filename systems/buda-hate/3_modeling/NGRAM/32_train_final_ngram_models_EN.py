...
# LR
lr_vectorizer_v1 = TfidfVectorizer(ngram_range=(1, 1), min_df=10, sublinear_tf=True, use_idf=True, smooth_idf=True)
...
# SVM
svm_vectorizer_v1 = TfidfVectorizer(ngram_range=(1, 1), min_df=6, sublinear_tf=True, use_idf=True, smooth_idf=True)
...
# RF
rf_vectorizer_v1 = TfidfVectorizer(ngram_range=(1, 2), min_df=7)
...
rf_v1 = RandomForestClassifier(n_estimators=300, min_samples_leaf=8, criterion='gini', random_state=0, oob_score=True)
rf_v1.fit(rf_X_v1, data_v2["spreader"])
pickle.dump(rf_v1, open('../../models/en/rf_v2.sav', 'wb'))

# Fitting best XGB
xgb_en_v1 = xgb.XGBClassifier(colsample_bytree=0.7, eta=0.1, max_depth=6, n_estimators=300, subsample=0.8)
