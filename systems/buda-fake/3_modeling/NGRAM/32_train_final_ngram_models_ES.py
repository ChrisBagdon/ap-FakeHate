...
# LR
lr_vectorizer_v1 = TfidfVectorizer(min_df=10, ngram_range=(1, 2), use_idf=True, smooth_idf=True, sublinear_tf=True)
...
# SVM
svm_vectorizer_v1 = TfidfVectorizer(ngram_range=(2, 2), min_df=4, sublinear_tf=True, use_idf=True, smooth_idf=True)
...
# RF
rf_vectorizer_v1 = TfidfVectorizer(min_df=5, ngram_range=(1, 2), use_idf=True, smooth_idf=True, sublinear_tf=True)
...
rf_v1 = RandomForestClassifier(n_estimators=100, min_samples_leaf=6, criterion='gini')
...
xgb_es_v1 = xgb.XGBClassifier(colsample_bytree=0.7, eta=0.1, max_depth=5, n_estimators=300, subsample=0.8)
