...
# LR
lr_vectorizer_v1 = TfidfVectorizer(min_df=6, ngram_range=(2, 2), use_idf=True, smooth_idf=True, sublinear_tf=True)
...
# SVM
svm_vectorizer_v1 = TfidfVectorizer(ngram_range=(1, 2), min_df=10, sublinear_tf=True, use_idf=True, smooth_idf=True)
...
rf_v1 = RandomForestClassifier(n_estimators=300, min_samples_leaf=5, criterion='gini')
...
xgb_X_v1 = vect_xgb_es_v1.fit_transform(data_v2_es['Tweets'])
pickle.dump(vect_xgb_es_v1, open('../../models/es/vect_xgb_es_v1.pickle', 'wb'))
xgb_es_v1 = xgb.XGBClassifier(colsample_bytree=0.5, eta=0.1, max_depth=3, n_estimators=200, subsample=0.6)
