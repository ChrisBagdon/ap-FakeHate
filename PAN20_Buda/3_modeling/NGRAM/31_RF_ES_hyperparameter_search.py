...
rf_results_v1.to_csv('../../training_results/ES/rf_tfidf_results_v1.tsv', sep='\t', index=False)
...
for params in grid:
    ...
    oob = rf_clf.oob_score_
    rf_results_2.append(oob)
    if i % 10 == 0:
        print(i)
        print(time.strftime("%m/%d/%Y %H:%M:%S"))
rf_results_v2['results'] = rf_results_2
rf_results_v2.to_csv('../../training_results/ES/rf_tfidf_results_v2.tsv', sep='\t', index=False)
